...
@section('content')
    ...
    <section class="section">
        ...
        : asset('assets/img/profile-img.webp') }}" alt="{{ $doctor->user?->name ?? 'Doctor' }}">
                        {{--
                        <button type="button" class="profile-avatar-edit" title="Change photo">
                    ...
                    <div class="text-center mt-3">
                        ...
                        @if(
                                method_exists($doctor->user, 'isActive')
                ...
                <div class="profile-actions">
                    ...
                    <a href="{{ route('doctor.doctors.edit', $doctor) }}" class="profile-action-btn bg-white text-black  ">
                    ...
                    {{-- <a href="{{ route('doctor.doctors.index') }}" class="profile-action-btn bg-light">
            ...
            <div class="col-xl-8">
                ...
                <div class="profile-tabs-wrapper">
                    ...
                    <div class="profile-tabs">
                        ...
                        <button class="profile-tab" data-tab="patients">
                ...
                <div class="profile-tab-content">
                    ...
                    <div class="profile-tab-pane active" id="tab-overview">
                    ...
                    <div class="profile-tab-pane" id="tab-patients">
                                                ...
                                                @foreach($patients as $patient)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if(
                                                                    $patient->devices &&
                                                                    $patient->devices->count()
                                                                )

                                                                {{ $patient->devices->first()->device_name ?: $patient->devices->first()->device_uid }}
                    ...
                    <div class="profile-tab-pane" id="tab-devices">
